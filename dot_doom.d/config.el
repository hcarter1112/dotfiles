...
(add-to-list 'default-frame-alist '(alpha . 100))        ;; transparency/opacity

;; This is to activate beacon mode globally
(beacon-mode 1)
...
(nvmap :states '(normal visual) :keymaps 'override :prefix "SPC"
               ...
               "d f" '(dired-other-frame :which-key "Open dired in another frame")
...
(setq message-send-mail-function 'smtpmail-send-it
   ...
   smtpmail-auth-credentials
     '(("smtp.gmail.com" 587 "hcarter1112@gmail.com" nil))
...
;; Add a sxhkd mode so that reloading the file is easier
