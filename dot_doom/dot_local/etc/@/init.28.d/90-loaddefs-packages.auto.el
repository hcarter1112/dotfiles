...
(fn THEME &rest FACES)" nil nil)(function-put 'doom-themes-set-faces 'lisp-indent-function 'defun)(when (and (boundp 'custom-theme-load-path) "~/.doom/.local/straight/build-28.1/doom-themes/doom-themes-autoloads.el") (let* ((base (file-name-directory "~/.doom/.local/straight/build-28.1/doom-themes/doom-themes-autoloads.el")) (dir (expand-file-name "themes/" base))) (add-to-list 'custom-theme-load-path (or (and (file-directory-p dir) dir) base))))(autoload 'doom-themes-neotree-config "doom-themes-ext-neotree" "Install doom-themes' neotree configuration.
...
(fn &optional ARG)" t nil)(autoload 'posframe-workable-p "posframe" "Test posframe workable status." nil nil)(autoload 'posframe-show "posframe" "Pop up a posframe to show STRING at POSITION.
...
(fn &optional ARG)" t nil)(autoload 'ivy-switch-buffer "ivy" "Switch to another buffer." t nil)(autoload 'ivy-switch-view "ivy" "Switch to one of the window views stored by `ivy-push-view'." t nil)(autoload 'ivy-switch-buffer-other-window "ivy" "Switch to another buffer in another window." t nil)(autoload 'counsel-company "counsel" "Complete using `company-candidates'." t nil)(autoload 'counsel-irony "counsel" "Inline C/C++ completion using Irony." t nil)(autoload 'counsel-describe-variable "counsel" "Forward to `describe-variable'.
...
(fn &optional ARG)" t nil)(autoload 'swiper-avy "swiper" "Jump to one of the current swiper candidates with `avy'." t nil)(autoload 'swiper-backward "swiper" "`isearch-backward' with an overview.
When non-nil, INITIAL-INPUT is the initial search pattern.
...
(fn &optional INITIAL-INPUT)" t nil)(autoload 'sudo-edit-set-header "sudo-edit" "*Display a warning in header line of the current buffer.
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `sudo-edit-indicator-mode'.")(autoload 'sudo-edit-indicator-mode "sudo-edit" "Indicates editing as root by displaying a message in the header line.
...
(fn FILENAME)" t nil)(autoload 'dired-open-file "dired-open" "Try `dired-open-functions' to open the thing under point.
...
(fn &optional ARG)" t nil)(autoload 'peep-dired "peep-dired" "A convienent way to look up file contents in other window while browsing directory in dired
...
(fn &optional ARG)" t nil)(autoload 'all-the-icons-dired-mode "all-the-icons-dired" "Display all-the-icons icon for each file in a Dired buffer.
...
(fn &optional ARG)" t nil)(autoload 'beacon-blink "beacon" "Blink the beacon at the position of the cursor.
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `beacon-mode'.")(autoload 'beacon-mode "beacon" "Toggle Beacon mode on or off.
...
(fn &optional ARG)" t nil)(autoload 'autothemer-deftheme "autothemer" "Define a theme NAME with description DESCRIPTION.
...
(fn &optional REGEXP)" t nil)(defvar minimap-mode nil "Non-nil if Minimap mode is enabled.
...
(fn &optional ARG)" t nil)(autoload 'tldr-update-docs "tldr" "Get or update the TLDR docs from source." t nil)(autoload 'tldr "tldr" "Lookup TLDR docs.

(fn &optional CMD)" t nil)(autoload 'helm-tldr "tldr" "Helm interface for `tldr'." t nil)(autoload 'defhydra "hydra" "Create a Hydra - a family of functions with prefix NAME.
...
(fn NAME BODY &optional DOCSTRING &rest HEADS)" nil t)(function-put 'defhydra 'lisp-indent-function 'defun)(function-put 'defhydra 'doc-string-elt '3)(defvar amx-mode nil "Non-nil if Amx mode is enabled.
...
(fn &optional ARG)" t nil)(autoload 'emojify-set-emoji-styles "emojify" "Set the type of emojis that should be displayed.
...
This respects the `emojify-emoji-styles' variable." t nil)(autoload 'ts-fold-mode "ts-fold" "Folding code using tree sitter.
...
The buffer on focus when the command is called is set as the target buffer." t nil)(autoload 'adaptive-wrap-prefix-mode "adaptive-wrap" "Wrap the buffer text with adaptive filling.
...
Will prompt you shell name when you type `C-u' before this command." t nil)(autoload 'multi-term-dedicated-toggle "multi-term" "Toggle dedicated `multi-term' window." t nil)(autoload 'multi-term-dedicated-select "multi-term" "Select the `multi-term' dedicated window." t nil)(autoload 'vterm-module-compile "vterm" "Compile vterm-module." t nil)(autoload 'vterm--bookmark-handler "vterm" "Handler to restore a vterm bookmark BMK.
...
(fn &optional ARG)" t nil)(autoload 'flyspell-correct-at-point "flyspell-correct" "Correct word before point using `flyspell-correct-interface'.
...
(fn &optional FORCE)" t nil)(defalias 'langtool-check 'langtool-check-buffer)(autoload 'langtool-check-buffer "langtool" "Check context current buffer and light up errors.
...
(fn &optional ARG)" t nil)(autoload 'editorconfig-apply "editorconfig" "Get and apply EditorConfig properties to current buffer.
...
(fn NAME SUPERCLASS SLOTS &rest OPTIONS-AND-DOC)" nil t)(function-put 'marshal-defclass 'lisp-indent-function '2)(autoload 'ivy-xref-show-xrefs "ivy-xref" "Show the list of xrefs returned by FETCHER and ALIST via ivy.
...
(fn FETCHER ALIST)" nil nil)(autoload 'makefile-executor-execute-target "makefile-executor" "Execute a Makefile target from FILENAME.
...
(fn ARG)" t nil)(autoload 'makefile-executor-goto-makefile "makefile-executor" "Interactively choose a Makefile to visit." t nil)(autoload 'rainbow-mode "rainbow-mode" "Colorize strings that represent colors.
...
(fn GROUP &optional PREVIOUS END QUERY)" nil nil)(defconst json-mode-standard-file-ext '(".json" ".jsonld") "List of JSON file extensions.")(defsubst json-mode--update-auto-mode (filenames) "Update the `json-mode' entry of `auto-mode-alist'.
...
(fn BEGIN END)" t nil)(autoload 'jsons-print-path "json-snatcher" "Print the path to the JSON value under point, and save it in the kill ring." t nil)(autoload 'counsel-jq "counsel-jq" "Counsel interface for dynamically querying jq.
Whenever you're happy with the query, hit RET and the results
will be displayed to you in the buffer in `counsel-jq-buffer'." t nil)(autoload 'lua-mode "lua-mode" "Major mode for editing Lua code.
...
(fn COMMAND &optional ARG &rest IGNORED)" t nil)(autoload 'pip-requirements-auto-complete-setup "pip-requirements" "Setup Auto-Complete for Pip Requirements.
...
call this function in `noninteractive' sessions." nil nil)(autoload 'py-isort-region "py-isort" "Uses the \"isort\" tool to reformat the current region." t nil)(autoload 'py-isort-buffer "py-isort" "Uses the \"isort\" tool to reformat the current buffer." t nil)(autoload 'py-isort-before-save "py-isort" nil t nil)(autoload 'rustic-mode "rustic" "Major mode for Rust code.
...
(fn)" t nil)(autoload 'rust-dbg-wrap-or-unwrap "rust-utils" "Either remove or add the dbg! macro." t nil)(autoload 'spinner-create "spinner" "Create a spinner of the given TYPE.
...
(fn &optional TYPE-OR-OBJECT FPS DELAY)" nil nil)(autoload 'xterm-color-filter-strip "xterm-color" "Translate ANSI color sequences in STRING into text properties.
...
comparisons/benchmarks with libraries that offer similar functionality." t nil)(let ((loads (get 'yaml 'custom-loads))) (if (member '"yaml-mode" loads) nil (put 'yaml 'custom-loads (cons '"yaml-mode" loads))))(autoload 'yaml-mode "yaml-mode" "Simple mode to edit YAML.

\\{yaml-mode-map}

(fn)" t nil)(defvar org-msg-mode nil "Non-nil if Org-Msg mode is enabled.
...
(fn)" t nil)(autoload 'log4e:insert-start-log-quickly "log4e" "Insert logging statment for trace level log at start of current function/macro." t nil)(autoload 'highlight-indent-guides-auto-set-faces "highlight-indent-guides" "Automatically calculate indent guide faces.
...
(fn &optional ARG)" t nil)(autoload 'pdf-annot-minor-mode "pdf-annot" "Support for PDF Annotations.
...
(fn &optional FILENAMES BUFFER-NAME DISPLAY-P)" t nil)(autoload 'tablist-minor-mode "tablist" "Toggle Tablist minor mode on or off.
...
(fn)" t nil)(autoload 'org-pdftools-open "org-pdftools" "Function to open org-pdftools LINK.
