...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "54c03b21f763fa775a4c0643a9d8326342873179"
  WORKING_DIRECTORY "/home/ralldi/.doom/.local/straight/build-28.1/vterm/build/libvterm-prefix/src/libvterm"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ralldi/.doom/.local/straight/build-28.1/vterm/build/libvterm-prefix/src/libvterm'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ralldi/.doom/.local/straight/build-28.1/vterm/build/libvterm-prefix/src/libvterm'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
